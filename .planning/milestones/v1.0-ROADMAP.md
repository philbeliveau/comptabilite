...
- [ ] **Phase 6: Fava Dashboard UX** - Pedagogical tooltips, sidebar dropdowns, and beginner-friendly navigation
...
| 6. Fava Dashboard UX | 1/2 | In progress | - |

### Phase 6: Fava Dashboard UX: Pedagogical Tooltips, Sidebar Dropdowns, and Beginner-Friendly Navigation
**Goal**: The Fava web dashboard is intuitive for a beginner in accounting: the sidebar uses collapsible dropdowns grouped by section instead of a flat list of tabs, every report tab has a plain-language explanation of its purpose, and hovering over any table header, calculated value, or metric shows a pedagogical tooltip explaining what it is, why it matters, and which Python function generates it -- all in simple, jargon-free French
**Depends on**: Phase 4, Phase 5
**Requirements**: UX-01, UX-02, UX-03, UX-04, UX-05
**Success Criteria** (what must be TRUE):
  1. Fava sidebar navigation uses collapsible dropdown sections (e.g., "Rapports financiers", "Taxes Quebec", "Paie", "Outils") instead of showing all tabs flat -- user can expand/collapse each section
  2. Every report tab (trial balance, P&L, balance sheet, payroll, CCA, GST/QST, shareholder loan) has a header block explaining in plain French what the report shows, who uses it, and why it matters
  3. Hovering over any table column header, calculated total, or metric value shows a tooltip popup with: (a) what this number represents, (b) a high-level explanation of the calculation, and (c) the Python function/module that produces it
  4. Tooltips are consistent in style, non-intrusive (appear on hover, disappear on mouse-out), and work on both desktop and tablet
  5. All explanatory text is written at a beginner level -- no unexplained jargon, with examples where helpful
**Plans**: 2 plans

Plans:
- [x] 06-01-PLAN.md — Collapsible sidebar with French section headers, report header blocks, and tooltip CSS foundation
- [ ] 06-02-PLAN.md — Tooltip dictionary (40+ entries), attachTooltips() logic, and visual verification checkpoint
