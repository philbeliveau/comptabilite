...
number: 4
name: Pending transactions staged in pending.beancount
expected: |
  After import, AI-categorized transactions with confidence between 80-95% appear in pending.beancount with #pending tag and metadata (source_ia, confiance, compte_propose).
...
result: skipped
reason: No test data with transactions over $500 available. Will test another day.
...
result: skipped
reason: User not interested in testing this now.
