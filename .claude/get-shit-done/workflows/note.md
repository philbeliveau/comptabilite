...
- **Global scope**: `/Users/philippebeliveau/Desktop/Notebook/comptabilite/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/philippebeliveau/Desktop/Notebook/comptabilite/.claude/notes/`)
...
2. Glob `/Users/philippebeliveau/Desktop/Notebook/comptabilite/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/philippebeliveau/Desktop/Notebook/comptabilite/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/philippebeliveau/Desktop/Notebook/comptabilite/.claude/notes/` — works in any directory
