...
```bash
node "/Users/philippebeliveau/Desktop/Notebook/comptabilite/.cursor/get-shit-done/bin/gsd-tools.cjs" config-ensure-section
...
Use conversational prompting with current values pre-selected:
