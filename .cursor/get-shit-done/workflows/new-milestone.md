...
- Ask inline (freeform, NOT conversational prompting): "What do you want to build next?"
- Wait for their response, then use conversational prompting to probe specifics
- If user selects "Other" at any point to provide freeform input, ask follow-up as plain text — not another conversational prompting
...
**If "Adjust":** Ask what needs changing (plain text, NOT conversational prompting). Incorporate changes, re-present the summary. Loop until "Looks good" is selected.
...
```bash
node "/Users/philippebeliveau/Desktop/Notebook/comptabilite/.cursor/get-shit-done/bin/gsd-tools.cjs" commit "docs: start milestone v[X.Y] [Name]" --files .planning/PROJECT.md .planning/STATE.md
```

## 7. Load Context and Resolve Models

```bash
INIT=$(node "/Users/philippebeliveau/Desktop/Notebook/comptabilite/.cursor/get-shit-done/bin/gsd-tools.cjs" init new-milestone)
...
conversational prompting: "Research the domain ecosystem for new features before defining requirements?"
...
Use template: /Users/philippebeliveau/Desktop/Notebook/comptabilite/.cursor/get-shit-done/templates/research-project/{FILE}
</output>
...
**Scope each category** via conversational prompting (multiSelect: true, header max 12 chars):
...
**Identify gaps** via conversational prompting:
...
**Commit requirements:**
```bash
node "/Users/philippebeliveau/Desktop/Notebook/comptabilite/.cursor/get-shit-done/bin/gsd-tools.cjs" commit "docs: define milestone v[X.Y] requirements" --files .planning/REQUIREMENTS.md
```
...
**Ask for approval** via conversational prompting:
...
```bash
node "/Users/philippebeliveau/Desktop/Notebook/comptabilite/.cursor/get-shit-done/bin/gsd-tools.cjs" commit "docs: create milestone v[X.Y] roadmap ([N] phases)" --files .planning/ROADMAP.md .planning/STATE.md .planning/REQUIREMENTS.md
```
