...
**GSD** (Get Shit Done) creates hierarchical project plans optimized for solo agentic development with Cursor.
...
- Saves timestamped note to `.planning/notes/` (or `/Users/philippebeliveau/Desktop/Notebook/comptabilite/.cursor/notes/` globally)
