...
```bash
INIT=$(node "/Users/philippebeliveau/Desktop/Notebook/comptabilite/.cursor/get-shit-done/bin/gsd-tools.cjs" init manager)
...
Present via conversational prompting:
- **question:** "What would you like to do?"
- **options:** (compound options as built above + refresh + exit, conversational prompting auto-adds "Other")
...
Steps:
1. Read the plan-phase workflow: cat /Users/philippebeliveau/Desktop/Notebook/comptabilite/.cursor/get-shit-done/workflows/plan-phase.md
2. Run: node \"/Users/philippebeliveau/Desktop/Notebook/comptabilite/.cursor/get-shit-done/bin/gsd-tools.cjs\" init plan-phase {N}
...
Important: You are running in the background. Do NOT use conversational prompting — make autonomous decisions based on project context. If you hit a blocker, write it to STATE.md as a blocker and stop. Do NOT silently work around permission or file access errors — let them fail so the manager can surface them with resolution hints."
)
```
...
Steps:
1. Read the execute-phase workflow: cat /Users/philippebeliveau/Desktop/Notebook/comptabilite/.cursor/get-shit-done/workflows/execute-phase.md
2. Run: node \"/Users/philippebeliveau/Desktop/Notebook/comptabilite/.cursor/get-shit-done/bin/gsd-tools.cjs\" init execute-phase {N}
...
Important: You are running in the background. Do NOT use conversational prompting — make autonomous decisions. Use --no-verify on git commits. If you hit a permission error, file lock, or any access issue, do NOT work around it — let it fail and write the error to STATE.md as a blocker so the manager can surface it with resolution guidance."
)
```
...
- Display the error, then offer options via conversational prompting:
