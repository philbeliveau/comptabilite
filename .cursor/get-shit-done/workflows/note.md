...
- **Global scope**: `/Users/philippebeliveau/Desktop/Notebook/comptabilite/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/philippebeliveau/Desktop/Notebook/comptabilite/.cursor/notes/`)
...
2. Glob `/Users/philippebeliveau/Desktop/Notebook/comptabilite/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (/Users/philippebeliveau/Desktop/Notebook/comptabilite/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/philippebeliveau/Desktop/Notebook/comptabilite/.cursor/notes/` — works in any directory
