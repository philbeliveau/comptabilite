...
**commands/gsd/**
- Purpose: Slash command definitions for Cursor
...
- `.cursor/rules/` - Instructions for Cursor when working in this repo
...
- Usage: Reference from command with `@/Users/philippebeliveau/Desktop/Notebook/comptabilite/.cursor/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/philippebeliveau/Desktop/Notebook/comptabilite/.cursor/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/philippebeliveau/Desktop/Notebook/comptabilite/.cursor/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
